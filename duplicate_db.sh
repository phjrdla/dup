...
[[ -z $dest_sid_pwd ]]  && { dest_sid_pwd="Qmx0225_${lowerDEST_SID}"; print "dest_sid_pwd according to convention : $dest_sid_pwd"; }
...
(( ${#dbname} > 8 )) && { print "db_name length is > 8, exit."; exit; }
...
asmspfile="$db_create_file_dest/$DEST_SID/PARAMETERFILE/spfile${DEST_SID}.ora"
