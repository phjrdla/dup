...
passwordfile="$ORACLE_HOME/dbs/orapw${db_name}"
...
if (( instanceUp == 1 ))
then
  print "About to abort instance $db_name"
...
$DEBUG orapwd file=$passwordfile password=$SourceSidPwd entries=10  force=y format=12
